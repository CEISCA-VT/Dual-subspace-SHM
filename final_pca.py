...
# CONFIG
# ---------------------------
DEVICE_FOLDER = r"./00_master_dataset"    # folder with CSV sweeps
REPORT_DIR   = r"./64reports"    # folder for outputs

PREFERRED_REG_INDEX_SINGLE = 5
PREFERRED_AUTH_INDEX_SINGLE = 4
PREFERRED_MULTI_TRAIN_INDICES = list(range(4,7))
PREFERRED_MULTI_AUTH_INDEX = 6
...
# CUSTOM CONTROLS
# ---------------------------
EXCLUDED_DEVICES = ["1"]          # e.g., ["dev2", "bad_device_7"]
...
def plot_distribution(values,title,outpath,color="steelblue"):
    plt.figure(figsize=(7,5))
    plt.hist(values,bins=20,alpha=0.8,color=color)
...
def run_all_tests(folder):
    ...
    plot_distribution(intra_s,"Single-sweep Intra distances",os.path.join(REPORT_DIR,"single_intra.png"),"skyblue")
    plot_distribution(inter_s,"Single-sweep Inter distances",os.path.join(REPORT_DIR,"single_inter.png"),"salmon")
    ...
    plot_distribution(intra_m,"Multi-sweep Intra distances",os.path.join(REPORT_DIR,"multi_intra.png"),"skyblue")
    plot_distribution(inter_m,"Multi-sweep Inter distances",os.path.join(REPORT_DIR,"multi_inter.png"),"salmon")
